CREATE DATABASE IF NOT EXISTS `movies` DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci;
USE `movies`;
...
CREATE TABLE `actor` (
  ...
  `act_fname` char(20) COLLATE utf8_polish_ci DEFAULT NULL,
  `act_lname` char(20) COLLATE utf8_polish_ci DEFAULT NULL,
  `act_gender` char(1) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`act_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

CREATE TABLE `director` (
  `dir_id` int(11) NOT NULL,
  `dir_fname` char(20) COLLATE utf8_polish_ci DEFAULT NULL,
  `dir_lname` char(20) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`dir_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

CREATE TABLE `genres` (
  `gen_id` int(11) NOT NULL,
  `gen_title` char(20) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`gen_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

CREATE TABLE `movie` (
  `mov_id` int(11) NOT NULL,
  `mov_title` char(50) COLLATE utf8_polish_ci DEFAULT NULL,
  `mov_year` int(11) DEFAULT NULL,
  `mov_time` int(11) DEFAULT NULL,
  `mov_lang` char(15) COLLATE utf8_polish_ci DEFAULT NULL,
  `mov_dt_rel` date DEFAULT NULL,
  `mov_rel_country` char(5) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`mov_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `movie_cast` (
  `act_id` int(11) NOT NULL,
  `mov_id` int(11) NOT NULL,
  `role` char(30) COLLATE utf8_polish_ci DEFAULT NULL,
...
CREATE TABLE `reviewer` (
  ...
  `rev_name` char(30) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`rev_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
INSERT INTO `movie_director` VALUES (201,901),(202,902),(203,903),(204,904),(205,905),(206,906),(207,907),(208,908),(209,909),(210,910),(211,911),(212,912),(213,913),(214,914),(215,915),(216,916),(217,917),(218,918),(219,919),(220,920),(218,921),(215,922),(221,923);
